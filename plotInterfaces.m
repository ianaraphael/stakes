...
% plots interfaces of all stakes by type and site
...
iceTypePlots = true; % get plots by ice type
sitePlots = true; % get plots by stakes site
allStakesPlots = false; % get plots for all stakes
    ...
    for i = 1:length(indivSites)
        ...
        for i2 = 1:length(indivStakes)
            ...
            l = plot(datenum(allStakes.measurementDate(allStakes.stakeID==indivStakes(i2))),...
                allStakes.thicknessGaugeMeasurementNormalized(allStakes.stakeID==indivStakes(i2)),'b');
            l.MarkerFaceColor = l.Color;
            
            % plot the top as well
            l = plot(datenum(allStakes.measurementDate(allStakes.stakeID==indivStakes(i2))),...
                allStakes.iceSurfaceMeasurementNormalized(allStakes.stakeID==indivStakes(i2)),'k');
            l.MarkerFaceColor = l.Color;
            
            % then plot snow over top
            l = plot(datenum(allStakes.measurementDate(allStakes.stakeID==indivStakes(i2))),...
                allStakes.snowSurfaceMeasurementNormalized(allStakes.stakeID==indivStakes(i2)),'r');
            l.MarkerFaceColor = l.Color;
        end
    ...
    for i = 1:2
       ...
       % for every stake
        for i2 = 1:length(indivStakes)
            ...
            % plot the top as well
            l = plot(datenum(allStakes.measurementDate(allStakes.stakeID==indivStakes(i2))),...
                allStakes.iceSurfaceMeasurementNormalized(allStakes.stakeID==indivStakes(i2)));
            l.MarkerFaceColor = l.Color;
            
            % then plot snow over top
            l = plot(datenum(allStakes.measurementDate(allStakes.stakeID==indivStakes(i2))),...
                allStakes.snowSurfaceMeasurementNormalized(allStakes.stakeID==indivStakes(i2)));
            l.MarkerFaceColor = l.Color;
        end
